...
type ThirdPartyServiceClient interface {
	...
	VerificationJamkrindo(ctx context.Context, in *SubmitJamkrindoCalonRequest, opts ...grpc.CallOption) (*SubmitJamkrindoCalonResponse, error)
}
...
func (c *thirdPartyServiceClient) VerificationJamkrindo(ctx context.Context, in *SubmitJamkrindoCalonRequest, opts ...grpc.CallOption) (*SubmitJamkrindoCalonResponse, error) {
	out := new(SubmitJamkrindoCalonResponse)
	err := c.cc.Invoke(ctx, "/proto.ThirdPartyService/VerificationJamkrindo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ThirdPartyServiceServer interface {
	...
	//submit Jamkrindo Calon
	VerificationJamkrindo(context.Context, *SubmitJamkrindoCalonRequest) (*SubmitJamkrindoCalonResponse, error)
...
func (UnimplementedThirdPartyServiceServer) VerificationJamkrindo(context.Context, *SubmitJamkrindoCalonRequest) (*SubmitJamkrindoCalonResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method VerificationJamkrindo not implemented")
}
...
func _ThirdPartyService_VerificationJamkrindo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SubmitJamkrindoCalonRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ThirdPartyServiceServer).VerificationJamkrindo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ThirdPartyService/VerificationJamkrindo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ThirdPartyServiceServer).VerificationJamkrindo(ctx, req.(*SubmitJamkrindoCalonRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ThirdPartyService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VerificationJamkrindo",
			Handler:    _ThirdPartyService_VerificationJamkrindo_Handler,
		},
	},
